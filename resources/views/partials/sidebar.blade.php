    ...
    <nav class="mt-4">
        <ul>
            <li class="hover:bg-blue-500 hover:text-white transition-colors">
                ...
                @endphp
                <a href="{{$dashboardUrl}}"
                    class=" {{ request()->is('user/dashboard') ? 'bg-blue-500 text-white' : 'hover:bg-blue-500 hover:text-white' }} block py-3 px-5 flex items-center space-x-3">
                    <i class='bx bxs-dashboard'></i>
                    <span>Dashboard</span>
                </a>
            </li>
            <li
                class="{{ request()->is('user/leaves') ? 'bg-blue-500 text-white' : 'hover:bg-blue-500 hover:text-white' }} transition-colors">
                <a href="/user/leaves" class="block py-3 px-5 rounded-lg flex items-center space-x-3">
