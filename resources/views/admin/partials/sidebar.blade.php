<aside id="sidebar" class="sidebar fixed inset-y-0 left-0 z-40 w-64 bg-gradient-to-b from-gray-800 to-gray-900 text-white transform -translate-x-full md:translate-x-0 md:relative md:flex-shrink-0 transition-transform duration-300 overflow-hidden">
    ...
    <nav class="mt-4">
        <ul>
            <li class="hover:bg-blue-500 hover:text-white transition-colors">
                ...
                @endphp
                <a href="{{$dashboardUrl}}" class=" {{ request()->is('admin/dashboard') ? 'bg-blue-500 text-white' : 'hover:bg-blue-500 hover:text-white' }} block py-3 px-5 flex items-center space-x-3">
                    <i class='bx bxs-dashboard'></i>
                    <span>Dashboard</span>
                </a>
            </li>
            <li class="{{ request()->is('admin/user') ? 'bg-blue-500 text-white' : 'hover:bg-blue-500 hover:text-white' }} transition-colors">
